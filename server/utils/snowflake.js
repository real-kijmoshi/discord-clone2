class Worker {
    ...
    nextId(dataTypeReadable) {
        ...
        const dataType = parseInt(Object.keys(this.types).find(key => this.types[key] === dataTypeReadable), 10);
        ...
        // return decimal
        return (BigInt(timestamp) << 22n) | (BigInt(this.workerId) << 14n) | (BigInt(this.sequence) << 4n) | BigInt(dataType);
    }
